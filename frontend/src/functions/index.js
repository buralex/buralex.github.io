...
export function starting() {
    ...
    function calcHeight() {
        ...
        var patternAbout = window.Trianglify({
        ...
        aboutBgElement.setAttribute('class', 'about-svg');
        ...
        bgElement.setAttribute('class', 'contact-svg');
    ...
    calcHeight();
    window.addEventListener("resize", debounce(calcHeight, 500));
...
export function flipCard(selector, classFlipped) {
...
----------------------------------------------------------------------------- */
export function flipText(selector, selectorImage, classFlipped, flippedAgain ) {
    var cards = document.querySelectorAll(selector);
...
----------------------------------------------------------------------------- */
export function navHide(navSel, upCl) {
    var lastScrollTop = 0;
    var delta = 5;
...
export function remNav(li, nav, removeClass, navbar, navbarHide) {
